module.exports = async (msg, args) => {
    ...
    const user = await msg.client.users.fetch(uid, {force:true, cache:false}).
                 catch(e => {});
    ...
    ppURL = user.bannerURL({extension:'png', size:1024});


    if (!ppURL) {
        msg.channel.send("Ce membre n'a pas de bannière");
        return;
    }
